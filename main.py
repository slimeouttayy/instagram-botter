...
def __main__:
 account_name=slimeout_tayy("Account name ? ")
   if account_name=="":
     print('Artavious')
   else if req.on(`https://www.instagram.com/slimeout_tayy/?ext=T&cmd=export&uuid=a5c19c52-9313-435c-8790-a35e1610cbda`)==Flase:
